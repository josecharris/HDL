<!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo RUTA.'index.php' ?>">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="<?php echo RUTA.'cruds/listar_vehiculo.php' ?>">Consultas vehiculos</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities" aria-expanded="true" aria-controls="collapseUtilities">
          ...
          <span>Administrar Informacion</span>
        </a>
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Consultar</h6>
            <a class="collapse-item" href="<?php echo RUTA.'cruds/listar_vehiculo.php' ?>">Vehiculo</a>
            <a class="collapse-item" href="<?php echo RUTA.'cruds/listar_conductor.php' ?>">Conductor</a>
            <a class="collapse-item" href="<?php echo RUTA.'cruds/listar_cliente.php' ?>">Cliente</a>
            <a class="collapse-item" href="<?php echo RUTA.'cruds/listar_destino.php' ?>">Destino</a>
          </div>
        </div>
      </li>
