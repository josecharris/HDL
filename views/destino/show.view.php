                ...
                <table class="table" style="margin-top: 30px;">
	                <thead class="thead-dark">
	                    <tr>
		                    ...
		                    <th style="border: 1px solid white;">Departamento</th>
	                ...
	                <tbody>
	                     <?php while($row = $result->fetch_array(MYSQLI_ASSOC)) { ?>
	                        <tr>
	                          ...
	                          <td class="bg-primary" style="color: white;"><?php echo $row['ciudadDestino']; ?></td>                         
	                          <td class="bg-success" style="color: white;"><?php echo $row['departamentoDestino']; ?></td>
	                          <td>
                 ...
                 <br>
                <center><h3>Ingresa informacion de nuevo destino</h3></center>
                <form method="POST" action="crear_destino.php">
                	<label>Ciudad: &nbsp;&nbsp;</label><input type="text" name="ciudad">
                	<label>&nbsp;Departamento: &nbsp;&nbsp;</label><input type="text" name="departamento">
                	<button class="btn btn-success" type="submit">Crear Destino</button>
                </form>
            </div>
        </div>
      </div>
