        	...
        	<div>
                <table class="table" style="margin-top: 30px;">
	                <thead class="thead-dark">
	                    <tr>
		                    <th style="border: 1px solid white;">Nit</th>
	                ...
	                <tbody>
	                     <?php while($row = $result->fetch_array(MYSQLI_ASSOC)) { ?>
	                        <tr>
	                          ...
	                          <td class="bg-primary" style="color: white;"><?php echo $row['nitCliente']; ?></td>                         
	                          <td class="bg-success" style="color: white;"><?php echo $row['nombreCliente']; ?></td>
	                          <td class="bg-warning" style="color: white;"><?php echo $row['telefonoCliente']; ?></td>
	                          <td class="bg-success" style="color: white;"><?php echo $row['direccionCliente']; ?></td>
	                          <td>
	                          	<a class="btn btn-primary btn-user" href="../cruds/actualizar_cliente.php?id=<?php echo $row['nitCliente']; ?>">Editar</a>
	                          	<a class="btn btn-danger btn-user" href="../cruds/eliminar_cliente.php?id=<?php echo $row['nitCliente']; ?>">Eliminar</a>
	                          </td>
	                        </tr>
                  ...
                  <br>
                <center><h3>Ingresa informacion de nuevo cliente</h3></center>
